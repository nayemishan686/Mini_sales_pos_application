                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="checkbox" name="status"
                                                ...
                                                @if ($product->status == 1) checked @endif value="1" checked
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            ...
                                            <textarea class="form-control textarea @error('description') is-invalid @enderror" name="description" id="summernote">{{ $product->description }}</textarea>
                                            @error('description')
                                                <div class="text text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
